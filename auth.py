...
from srs.models.models import User
from srs.models.schemas import UserModel


config = configparser.ConfigParser()
config.read('config.ini')

SECRET_KEY = f"{config.get('JWT', 'secret_key')}_{datetime.now().timestamp()}"
